      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 mb-24">
          ...
          <div className="space-y-8 text-foreground leading-relaxed flex flex-col justify-center">
            ...
            <p className="text-lg font-light">
              Авторская методология связывает грамматику, разговорную речь, фонетику и произношение в одну систему. Не четыре отдельных курса, а единая архитектура языка.
            </p>
