    ...
    <section id="format" className="py-20 md:py-28 px-6 relative overflow-hidden" style={{
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="bg-transparent md:bg-secondary/30 p-10 border border-white/20 md:border-border/50 space-y-4 hover:bg-white/10 md:hover:bg-white/10 transition-colors md:backdrop-blur-sm">
